  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/validators/affix.validator.ts',
        'src/validators/affix-confirmation.validator.ts',
        'src/validators/destination-stack.validator.ts',
        'src/validators/file-format.validator.ts',
        'src/validators/fileformat-confirmation.validator.ts',
        'src/validators/stack.validator.ts',
        'src/models/types.ts',
      ],
      thresholds: {
        lines: 80,
