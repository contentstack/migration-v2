...
running command...
$ csdx (--version)
@contentstack/cli-auth/1.3.20 darwin-arm64 node-v18.17.1
$ csdx --help [COMMAND]
USAGE
  $ csdx COMMAND
...
...
```
USAGE
  $ csdx auth:login [-u <value> | --oauth] [-p <value> | ] [-a <value> | ] [-e <value> | ]

FLAGS
  -a, --authToken=<value>  authtoken
  -e, --email=<value>      Email
...
```
USAGE
  $ csdx login [-u <value> | --oauth] [-p <value> | ] [-a <value> | ] [-e <value> | ]
