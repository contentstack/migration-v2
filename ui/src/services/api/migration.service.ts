...
export const getContentTypes = (
  ...
  try {
    ...
    return getCall(
      `${API_VERSION}/mapper/contentTypes/${projectId}?skip=${skip}&limit=${limit}&search=${encodedSearchText}`,
      options()
    );
  } catch (error) {
    if (error instanceof Error) {
...
export const getFieldMapping = async (
  ...
  try {
    ...
    return await getCall(
      `${API_VERSION}/mapper/fieldMapping/${projectId}/${contentTypeId}?skip=${skip}&limit=${limit}&search=${encodedSearchText}`,
      options()
    );
  } catch (error) {
    if (error instanceof Error) {
...
export const getMigrationLogs = async (
  ...
  try {
    return await getCall(
      `${API_VERSION}/migration/get_migration_logs/${orgId}/${projectId}/${stackId}?skip=${skip}&limit=${limit}&startIndex=${startIndex}&stopIndex=${stopIndex}&search=${searchText}&filter=${filter}`,
      options()
    );
  } catch (error) {
    if (error instanceof Error) {
