...
const LoadStacks = (props: LoadFileFormatProps) => {
  ...
  const [localePlaceholder, setlocalePlaceholder] = useState<string>(
  ...
  return (
    <div className="">
      <div className="row">
        ...
        <div className="col-12">
          <label className="title" htmlFor="master_locale">
      ...
      {newMigrationData?.destination_stack?.selectedStack?.value && (
        <div className="language-mapper">
          ...
          <LanguageMapper stack={selectedStack ?? DEFAULT_DROPDOWN} />
        </div>
      )}
    </div>
  );
