import { createLocale } from './api/src/services/drupal/locales.service.js';
...
async function testDrupalLocales() {
  ...
  try {
    ...
    if (fs.existsSync(masterLocalePath)) {
      ...
      console.log('❌ master-locale.json not found at:', masterLocalePath);
    }
    ...
    if (fs.existsSync(localesPath)) {
      ...
      console.log('❌ locales.json not found at:', localesPath);
    }
    ...
    if (fs.existsSync(languagePath)) {
      ...
      console.log('❌ language.json not found at:', languagePath);
    }
