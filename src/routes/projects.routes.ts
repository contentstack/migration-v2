...
router.get("/:id", asyncRouter(projectController.getProject));

// Create a new project route
router.post("/", asyncRouter(projectController.createProject));

// Delete a project route
router.delete("/:id", asyncRouter(projectController.deleteProject));

// Update a project route
router.put("/:id", asyncRouter(projectController.updateProject));
