...
import { extractContentTypes, extractLocale } from 'migration-sap-smartedit';
import { deleteFolderSync } from "../../helper";
import path from "path";

const createSapSmarteditMapper = async (filePath: string = "", projectId: string | string[], app_token: string | string[], affix: string | string[], config: any) => {
  try {
    ...
    console.error("🚀 ~ createSapSmarteditMapper ~ err:", err?.response?.data ?? err)
...
export default createSapSmarteditMapper;
