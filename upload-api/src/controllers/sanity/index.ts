...
import { extractContentTypes, extractLocale } from 'migration-sanity';
import { deleteFolderSync } from '../../helper';

const createSanityMapper = async (
  filePath = '',
  ...
  try {
    ...
    console.error('🚀 ~ createSanityMapper ~ err:', err?.response?.data ?? err);
...
export default createSanityMapper;
