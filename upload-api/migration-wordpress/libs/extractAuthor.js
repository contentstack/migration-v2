...
const extractAuthor = (item, type) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const author = {
        "status": 1,
        "isUpdated": false,
    ...
    if (Array.isArray(item)) {
        const fields = yield handleAuthorSchema(item === null || item === void 0 ? void 0 : item[0]);
        (_a = author === null || author === void 0 ? void 0 : author.fieldMapping) === null || _a === void 0 ? void 0 : _a.push(...fields.map(field => {
            var _a, _b;
        ...
        const fields = yield handleAuthorSchema(item);
        (_b = author === null || author === void 0 ? void 0 : author.fieldMapping) === null || _b === void 0 ? void 0 : _b.push(...fields.map(field => {
            var _a, _b;
            return (Object.assign(Object.assign({}, field), { isDeleted: false, advanced: Object.assign(Object.assign({}, field === null || field === void 0 ? void 0 : field.advanced), { mandatory: (_b = (_a = field === null || field === void 0 ? void 0 : field.advanced) === null || _a === void 0 ? void 0 : _a.mandatory) !== null && _b !== void 0 ? _b : false }) }));
        }));
    }
    const filePath = path_1.default.join(contentTypeFolderPath, `${type}.json`);
    yield helper_1.default.writeFileAsync(filePath, author, 4);
    console.log(`Successfully created unified content type: ${type}.json`);
    return;
});
exports.default = extractAuthor;
